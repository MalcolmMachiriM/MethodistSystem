...
namespace MethodistSubscription
{
    public partial class login : System.Web.UI.Page
    {
        ...
        private void LoginDetails()
        {
            try
            {
                ...
                UserManagement su = new UserManagement("con");
                ...
                if (su.ValidateUserLoginCreds(txtEmail.Text, txtPassword.Text))
                {
                    if (su.UserDetails != null)
                    {
                        ...
                        {
                            Response.Redirect(string.Format("Member/member-Dashboard"));
                        }
                        //if (Session["roleid"].ToString() == "3")
                        //{
                        //    Response.Redirect(string.Format("Member/MemberDashboard"));
                        //}
